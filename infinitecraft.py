...
st.subtitle("The way you play is by clicking 2 buttons (elements) on the sidebar (left) and if it's a valid/n combination, it'll give a new element. It is turing complete, meaning that you can achieve/n whatever you want. Eventually.")
